  ...
  return (
    <div className="min-h-dvh bg-brand-bg">
      <div className="max-w-2xl mx-auto p-4 space-y-5">
        ...
        <p className="text-xs text-brand-text-muted text-center pb-2">
          Revenue data is stored locally on this device.
          On mainnet, fees will be collected directly to your treasury wallet on-chain.
        </p>

        {/* Builder credit */}
        <div className="flex items-center justify-center gap-1.5 pb-8 pt-2">
          <span className="text-xs text-brand-text-muted">⚡ Built by</span>
          <a
          ...
          <span className="text-xs text-brand-text-muted">· CirclePay NG v0.1</span>
        </div>
      </div>
    </div>
  );
